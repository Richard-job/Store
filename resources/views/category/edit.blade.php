...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center font-weight-bold">{{ $category->name }}</div>

                    <div class="card-body">

                        <form method="POST" id="update.form" action="{{ route('category.update', $category->id) }}">
                            @csrf
                            @method('patch')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="exampleModalLabel">@lang('update category')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body text-capitalize font-weight-bold">
                    @lang('are you sure you want to update this category.')
                </div>
