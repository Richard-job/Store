                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex mt-3 justify-content-center">
                            <a class="btn btn-primary text-capitalize mx-2" href="{{ route('category.edit', $category->id) }}">@lang('edit')</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="exampleModalLabel">@lang('delete category')</h5>
